...
public class MapRenderer extends JPanel {
    ...
    private void drawCorner(Graphics2D g2, int px, int py, int margin, int roadWidth, 
        ...
        if (north && east) {
            ...
            g2.fillRect(px + margin, py, roadWidth, TILE_SIZE / 2 + margin);  
            g2.fillRect(px + margin, py + margin, TILE_SIZE - margin, roadWidth);  
            
            
            drawDashedLine(g2, centerX, py, centerX, centerY, new Color(220, 220, 220), 1);  
            drawDashedLine(g2, centerX, centerY, px + TILE_SIZE, centerY, new Color(220, 220, 220), 1);  
        } else if (north && west) {
            
            g2.fillRect(px + margin, py, roadWidth, TILE_SIZE / 2 + margin);  
            g2.fillRect(px, py + margin, TILE_SIZE - margin, roadWidth);  
            
            
            drawDashedLine(g2, centerX, py, centerX, centerY, new Color(220, 220, 220), 1);  
            drawDashedLine(g2, px, centerY, centerX, centerY, new Color(220, 220, 220), 1);  
        } else if (south && east) {
            
            g2.fillRect(px + margin, py + margin, roadWidth, TILE_SIZE - margin);  
            g2.fillRect(px + margin, py + margin, TILE_SIZE - margin, roadWidth);  
            
            
            drawDashedLine(g2, centerX, centerY, centerX, py + TILE_SIZE, new Color(220, 220, 220), 1);  
            drawDashedLine(g2, centerX, centerY, px + TILE_SIZE, centerY, new Color(220, 220, 220), 1);  
        } else if (south && west) {
